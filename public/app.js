        ...
        <div class="activity-item">
            ...
            <div class="activity-details">
                ...
                <div class="activity-info">
                    ${activity.propertyId.propertyName} - ${activity.salesRepId.name}
                </div>
            ...
            <tbody>
                ${state.data.activities.map(activity => `
                    <tr>
                        ...
                        <td>${activity.propertyId.propertyName}</td>
            ...
            <tbody>
                ${state.data.properties.map(property => `
                    <tr>
                        ...
                        <td>${property.location.lat.toFixed(4)}, ${property.location.lng.toFixed(4)}</td>
                        <td>
                            <div class="action-buttons">
